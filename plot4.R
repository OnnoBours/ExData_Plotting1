...
with(epowerconsumption, plot(DateTime, Global_active_power, xlab = "Day", ylab = "Global Active Power (kilowatts)",
                             lty = 1, type = "l"))

with(epowerconsumption, plot(DateTime, Voltage, xlab = "datetime", ylab = "Voltage",
                             lty = 1, type = "l"))
...
with(epowerconsumption, plot(DateTime, Global_reactive_power, xlab = "datetime",
                             lty = 1, type = "l"))
dev.off()
